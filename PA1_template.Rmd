...
```{r time_series_plot_of_steps_taken_per_5_min_interval, fig.keep="all", fig.show="asis"}
...
```{r total_steps_taken_each_day_imputed, message=FALSE, warning=FALSE, fig.keep="all", fig.show="asis"}
...
```{r average_steps_on_weekdays_and_weekend, fig.keep="all", fig.show="asis"}
