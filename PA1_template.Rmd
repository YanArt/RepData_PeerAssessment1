...
```{r total steps histogram, fig.keep='all', fig.show='asis'}
...
```{r time series plot of the average number of steps taken per 5 min interval, fig.keep='all', fig.show='asis'}
...
The name of the interval that contains the most steps on average across all the days in the dataset is `r max_int_name` and it contains `r max_int_val` steps.
...
```{r total number of steps taken each day (imputed), message=FALSE, warning=FALSE, fig.keep='all', fig.show='asis'}
...
```{r  total steps per day new mean and median, echo=FALSE}
...
```{r average steps on weekdays and weekend, fig.keep='all', fig.show='asis'}
